...
function sp_person_addon($atts) {
	...
	if($facebook || $twitter || $google_plus || $youtube || $linkedin || $pinterest || $flickr || $dribbble || $behance || $instagram) {
		...
		if($facebook) 		$social_icons .= '<li><a target="_blank" href="" class="facebook"' . $facebook . '"><i class="fa fa-facebook"></i></a></li>';
		if($twitter) 		$social_icons .= '<li><a target="_blank" href="" class="twitter"' . $twitter . '"><i class="fa fa-twitter"></i></a></li>';
		if($google_plus) 	$social_icons .= '<li><a target="_blank" href="" class="google-plus"' . $google_plus . '"><i class="fa fa-google-plus"></i></a></li>';
